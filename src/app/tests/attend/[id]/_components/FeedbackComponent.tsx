    ...
    <Card className="max-w-4xl mx-auto my-8 bg-primary">
      <CardContent className="p-6">
        <div className="flex items-center space-x-4">
          <MessageSquare className="hidden sm:block h-8 w-8 md:h-10 md:w-10 text-color7" />
          <div className="space-y-2 flex-grow">
            <h3 className="text-xl font-semibold leading-none tracking-tight text-color7">We value your feedback!</h3>
          ...
          <Button asChild className="bg-color6 hover:bg-color8">
            <Link href="/feedback">
              Give Feedback
