      ...
      <CardContent className="p-6">
        <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-4">
          ...
          <div className="space-y-2 flex-grow text-center md:text-left">
            <h3 className="text-xl font-semibold leading-none tracking-tight text-gray-800">Contribute to Our Growth!</h3>
          ...
          <Button size="lg" asChild className='bg-color7 hover:bg-color5 font-bold'>
