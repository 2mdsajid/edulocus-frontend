                    ...
                    <div className="-mr-2 flex items-center sm:hidden">
                        <Sheet open={isOpen} onOpenChange={setIsOpen}>
                            <SheetTrigger asChild>
                                <Button variant="ghost" className="inline-flex pt-16 items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-purple-500">
                                    <span className="sr-only">Open main menu</span>
                                    {isOpen ? (
                                        <X className={` ${!isScrolled ? "hidden" : "block"} text-gray-700 text-3xl h-12 w-10`} aria-hidden="true" />
                                    ) : (
                                        <Menu className="block text-gray-700 text-3xl h-12 w-10" aria-hidden="true" />
                                    )}
                                </Button>
                            </SheetTrigger>
                            <SheetContent side="right" className="w-[240px] pt-24 sm:hidden space-y-5">
                                <div className="">
                                    {user
